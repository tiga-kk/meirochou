...
```ts
{
  ...
  mapManifestPath: "./map-bundles/C108/manifest.json"
}
```

既存型に合わせてfield名を調整してよいが、意味を変えない。
dayごとにmanifest pathを複製しない。

## TDD procedure

- [ ] **Step 1: production registry testをREDで追加する**
...
- [ ] **Step 6: runtime loader integration testを書く**
...
Fixture event IDs:
Manifest path used by day1:
Manifest path used by day2:
